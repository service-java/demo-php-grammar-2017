...
<div class="main-right-addAll">
	...
	<table class="table">
		...
		<tr align="center" class="js-student">
			...
			<td><img id="append" src="/luo-PHP-Web/06-stuInfoManageApp/Public/images/append.png" /> <img id="remove" src="/luo-PHP-Web/06-stuInfoManageApp/Public/images/remove.png" /></td>
		</tr>
		<tr>
...
<script src="/luo-PHP-Web/06-stuInfoManageApp/Public/js/jquery.min.js"></script>
<script>

...
<div class="fancy">
    ...
    <p>日程标题：
      <input type="text" class="input" name="eventtitle" id="eventtitle" style="width:320px" value="<?php echo $title;?>"></p>
    <p style="height:100px;">日程内容：
      <label for="textarea"></label>
      <textarea name="eventcontent" id="eventcontent" cols="40" rows="4"><?php echo $content;?></textarea>
    </p>
    <p>开始时间：
    ...
    <p id="p_endtime" <?php if (!$end) echo ' style="display:none"';?> >结束时间：&nbsp;<input type="text" class="input datepicker" name="enddate" id="enddate" value="<?php echo $end_d;?>" readonly>

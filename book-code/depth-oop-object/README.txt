...
Second, if these scripts don't match those in the book you have, then you've most likely downloaded the wrong scripts. Each book I've written has its own section at the www.LarryUllman.com Web site. Each edition of a title also has its own section at that site. Each page on the Web site also clearly states the book title and edition for which it applies. 
